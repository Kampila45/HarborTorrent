...
export function NotFoundPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#904900]/5 rounded-full blur-[80px] pointer-events-none"></div>
      ...
      <div className="max-w-2xl w-full text-center relative z-10 animate-fade-in-up px-6">
        ...
        <div className="mb-10 flex justify-center">
          <div className="relative group perspective-1000">
            {/* Glow effect */}
            <div className="absolute inset-0 bg-[#005da9]/10 rounded-full blur-3xl scale-125 group-hover:scale-150 transition-transform duration-700"></div>
            <img 
              ref={imgRef}
              alt="404 Error"
        ...
        <div className="space-y-4">
          <h2 className="text-[24px] leading-[32px] tracking-[-0.02em] font-semibold text-[#37352F] dark:text-[#E9E9E7]">404</h2>
          <h3 className="text-[18px] leading-[24px] tracking-[-0.01em] font-semibold text-[#1d1c16] dark:text-[#E9E9E7]">This page has drifted off course</h3>
          <p className="text-[15px] leading-[24px] font-normal text-[#5F5E5B] dark:text-[#E9E9E7] max-w-md mx-auto">
            The content you're looking for was either moved, deleted, or never existed in the first place. Let's
            get you back to safe harbor.
          </p>
        </div>
